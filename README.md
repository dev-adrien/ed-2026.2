...
Repositório dedicado a códigos, atividades e materiais de estudo utilizados na disciplina de **Estrutura de Dados**, com implementações em linguagem C, do curso superior em **Análise e Desenvolvimento de Sistemas do IFCE - Campus Tauá**.

---

## 🔎 Neste repositório você pode encontrar:

- 📃 **[Exemplos trabalhados em aula e na monitoria](./exemplos/)**
- 👨‍💻 **[Atividades e listas práticas](./atividades/)**
- 📚 **[Slides e materiais de apoio](./materiais/)**
- 🔗 **Links e referências úteis**

---

## 📌 Links Úteis para Estudo e Aprofundamento

Abaixo estão reunidas as melhores referências, simuladores visuais, documentações e plataformas para praticar lógica e estruturas de dados em Linguagem C.

---

### 👁️ Visualizadores e Simuladores Interativos (Essenciais)
Ferramentas para enxergar o comportamento dos ponteiros, nós e alocação na memória:
- **[Visualgo](https://visualgo.net/en)**: Visualização animada de algoritmos e estruturas de dados (listas, pilhas, árvores, grafos).
- **[Data Structure Visualizations (USFCA)](https://www.cs.usfca.edu/~galles/visualization/Algorithms.html)**: Excelente para simular passo a passo inserções, remoções e percursos.
- **[Python Tutor (C Tutor)](https://pythontutor.com/c.html)**: Permite rodar código C no navegador visualizando a pilha (Stack), Heap, ponteiros e endereços de memória em tempo real.
- **[Algorithm Visualizer](https://algorithm-visualizer.org/)**: Visualizador interativo de código com controle de execução.
...
### ⚙️ Compiladores Online e Ferramentas
- **[OnlineGDB C Compiler](https://www.onlinegdb.com/online_c_compiler)**: IDE online para C com suporte a debugger (GDB).
- **[Godbolt Compiler Explorer](https://godbolt.org/)**: Útil para inspecionar como seu código C é transformado pelo compilador.
